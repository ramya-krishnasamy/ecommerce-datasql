...
(	EmpAddressID int IDENTITY(10000,2),
    AddressID int NOT NULL,       --Section A - (3) Database stability concerns
	CountryID int NOT NULL,
	HomeType varchar(50),
	UnitNumber int,
	CONSTRAINT PK_EMPLOYEEADDRESS_EmpAddressID PRIMARY KEY (EmpAddressID),
	CONSTRAINT FK_EMPLOYEEADDRESS_AddressID FOREIGN KEY(AddressID) REFERENCES ADDRESS(AddressID),
...
--SELECT * FROM MULTIPLE_ADDRESS

--3)Database stability concerns

ALTER TABLE EMPLOYEEADDRESS
ADD AddressID int FOREIGN KEY (AddressID) REFERENCES ADDRESS (AddressID);
